<div class="ui left fixed vertical pointing inverted menu">
    <a class="item{{ helper.activeMenu().activeClass('admin-home') }} header" href="{{ url(['for': 'admin']) }}" style="text-align: center">
        My home
    </a>
    ...
    <div class="item">
        ...
        <div class="menu">
            <a class="item{{ helper.activeMenu().activeClass('admin-lights') }}" href="{{ url.get() }}admin/lights">
                Lights<i class="file outline icon"></i>
            </a>
